        ...
        float aux_vec6[restrict n], jmtx_solver_arguments* args)
{
    ...
    return jmtx_bicgstab_crs(mtx, y, x, aux_vec1, aux_vec2, aux_vec3, aux_vec4, aux_vec5, aux_vec6, args);
}
        ...
        float aux_vec6[restrict n], jmtx_solver_arguments* args)
{
    ...
    return jmtx_bicgstab_cds(mtx, y, x, aux_vec1, aux_vec2, aux_vec3, aux_vec4, aux_vec5, aux_vec6, args);
}
