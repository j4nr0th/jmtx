                                     ...
                                     const jmtx_allocator_callbacks *allocator_callbacks)
{
    ...
    *p_out = jmtxc_convert_crs_to_ccs_inplace_transpose(cpy);
                                      ...
                                      const jmtx_allocator_callbacks *allocator_callbacks)
{
    ...
    return jmtxc_convert_crs_to_ccs(in, p_out, allocator_callbacks);
}
/**
                                     ...
                                     const jmtx_allocator_callbacks *allocator_callbacks)
{
    ...
    jmtx_result res = jmtxcs_matrix_ccs_transpose(in, &cpy, allocator_callbacks);
    if (res != JMTX_RESULT_SUCCESS)
    {
        return res;
    }
    *p_out = jmtxc_convert_ccs_to_crs_inplace_transpose(cpy);
    return JMTX_RESULT_SUCCESS;
}
                                      ...
                                      const jmtx_allocator_callbacks *allocator_callbacks)
{
    ...
    return jmtxc_convert_ccs_to_crs(in, p_out, allocator_callbacks);
}
/**
                                     ...
                                     const jmtx_allocator_callbacks *allocator_callbacks)
{
    ...
    jmtx_result res = jmtxc_matrix_crs_new(&mtx, in->base.rows, in->base.cols, max_entries, allocator_callbacks);
    if (res != JMTX_RESULT_SUCCESS)
    {
        return res;
    }
                                      ...
                                      const jmtx_allocator_callbacks *allocator_callbacks)
{
    ...
    return jmtxc_convert_cds_to_crs(in, p_out, allocator_callbacks);
}
                                     ...
                                     const jmtx_allocator_callbacks *allocator_callbacks)
{
    ...
    const uint_fast32_t max_entries = max_dia_len * jmtxc_matrix_cds_diagonal_count(in);
    jmtx_result res = jmtxc_matrix_ccs_new(&mtx, in->base.rows, in->base.cols, max_entries, allocator_callbacks);
    if (res != JMTX_RESULT_SUCCESS)
    {
        return res;
    }
                                      ...
                                      const jmtx_allocator_callbacks *allocator_callbacks)
{
    ...
    return jmtxc_convert_cds_to_ccs(in, p_out, allocator_callbacks);
}
                                     ...
                                     const jmtx_allocator_callbacks *allocator_callbacks)
{
    ...
    jmtx_result res =
        jmtxc_matrix_cds_new(&mtx, in->base.rows, in->base.cols, 0, (const int32_t[]){0}, allocator_callbacks);
    if (res != JMTX_RESULT_SUCCESS)
    {
        return res;
    }
                                      ...
                                      const jmtx_allocator_callbacks *allocator_callbacks)
{
    ...
    return jmtxc_convert_crs_to_cds(in, p_out, allocator_callbacks);
}
                                      ...
                                      const jmtx_allocator_callbacks *allocator_callbacks)
{
    ...
    return jmtxc_convert_ccs_to_cds(in, p_out, allocator_callbacks);
}
                                      ...
                                      const jmtx_allocator_callbacks *allocator_callbacks)
{
    ...
    return jmtxc_convert_brm_to_crs(in, p_out, allocator_callbacks);
}
                                      ...
                                      const jmtx_allocator_callbacks *allocator_callbacks)
{
    ...
    return jmtxc_convert_brm_to_ccs(in, p_out, allocator_callbacks);
}
/**
                                     ...
                                     const jmtx_allocator_callbacks *allocator_callbacks)
{
    ...
    _Complex float *const value_array =
                                      ...
                                      const jmtx_allocator_callbacks *allocator_callbacks)
{
    ...
    return jmtxc_convert_brm_to_cds(in, p_out, allocator_callbacks);
}
/**
                                     ...
                                     const jmtx_allocator_callbacks *allocator_callbacks)
{
    ...
    jmtx_result res = jmtxc_matrix_brm_new(&mtx, in->base.rows, in->base.cols, ubw, lbw, NULL, allocator_callbacks);
    if (res != JMTX_RESULT_SUCCESS)
    {
        return res;
    }
                                      ...
                                      const jmtx_allocator_callbacks *allocator_callbacks)
{
    ...
    return jmtxc_convert_crs_to_brm(in, p_out, allocator_callbacks);
}
                                      ...
                                      const jmtx_allocator_callbacks *allocator_callbacks)
{
    ...
    return jmtxc_convert_ccs_to_brm(in, p_out, allocator_callbacks);
}
                                     ...
                                     const jmtx_allocator_callbacks *allocator_callbacks)
{
    ...
    _Complex float *const values_in =
                                      ...
                                      const jmtx_allocator_callbacks *allocator_callbacks)
{
    ...
    return jmtxc_convert_cds_to_brm(in, p_out, allocator_callbacks);
}
