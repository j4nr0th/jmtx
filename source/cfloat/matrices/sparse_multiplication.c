        ...
        const jmtx_allocator_callbacks* allocator_callbacks)
{
    ...
    jmtx_result res = jmtxc_matrix_crs_new(&out, c_out, r_out, a->n_entries + b->n_entries, allocator_callbacks);
        ...
        const jmtx_allocator_callbacks* allocator_callbacks)
{
    ...
    jmtx_result res = jmtxc_matrix_ccs_new(&out, c_out, r_out, a->n_entries + b->n_entries, allocator_callbacks);
    if (res != JMTX_RESULT_SUCCESS)
    {
        return res;
    }
...
//        min_lbw = a->lower_bandwidth;
    ...
    jmtx_result res = jmtxc_matrix_brm_new(&out, c_out, r_out, max_ubw, max_lbw, NULL, allocator_callbacks);
    if (res != JMTX_RESULT_SUCCESS)
    {
        return res;
    }
