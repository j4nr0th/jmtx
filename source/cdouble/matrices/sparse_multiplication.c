        ...
        const jmtx_allocator_callbacks* allocator_callbacks)
{
    ...
    jmtx_result res = jmtxz_matrix_crs_new(&out, c_out, r_out, a->n_entries + b->n_entries, allocator_callbacks);
        ...
        const jmtx_allocator_callbacks* allocator_callbacks)
{
    ...
    jmtx_result res = jmtxz_matrix_ccs_new(&out, c_out, r_out, a->n_entries + b->n_entries, allocator_callbacks);
    if (res != JMTX_RESULT_SUCCESS)
    {
        return res;
    }
 ...
 */
_Complex double jmtxz_multiply_matrix_sparse_vectors(uint32_t n_a, const uint32_t i_a[const static n_a], const _Complex double v_a[const static n_a],
                                                    uint32_t n_b, const uint32_t i_b[const static n_b], const _Complex double v_b[const static n_b])
{
    _Complex double v = 0;
    uint32_t ia = 0, ib = 0;
    while (ia < n_a && ib < n_b)
...
//        min_lbw = a->lower_bandwidth;
    ...
    jmtx_result res = jmtxz_matrix_brm_new(&out, c_out, r_out, max_ubw, max_lbw, NULL, allocator_callbacks);
    if (res != JMTX_RESULT_SUCCESS)
    {
        return res;
    }
                                      ...
                                      const jmtx_allocator_callbacks* allocator_callbacks)
{
    ...
    jmtx_result res = jmtxz_matrix_cds_new(&out, c_out, r_out, 0, (int32_t[]){0}, allocator_callbacks);
    if (res != JMTX_RESULT_SUCCESS)
    {
