                                      ...
                                      const jmtx_allocator_callbacks *allocator_callbacks)
{
    ...
    return jmtxz_convert_crs_to_ccs(in, p_out, allocator_callbacks);
}
/**
                                     ...
                                     const jmtx_allocator_callbacks *allocator_callbacks)
{
    ...
    jmtx_result res = jmtxzs_matrix_ccs_transpose(in, &cpy, allocator_callbacks);
    if (res != JMTX_RESULT_SUCCESS)
    {
        return res;
    }
                                      ...
                                      const jmtx_allocator_callbacks *allocator_callbacks)
{
    ...
    return jmtxz_convert_ccs_to_crs(in, p_out, allocator_callbacks);
}
/**
                                      ...
                                      const jmtx_allocator_callbacks *allocator_callbacks)
{
    ...
    return jmtxz_convert_cds_to_crs(in, p_out, allocator_callbacks);
}
                                      ...
                                      const jmtx_allocator_callbacks *allocator_callbacks)
{
    ...
    return jmtxz_convert_cds_to_ccs(in, p_out, allocator_callbacks);
}
                                     ...
                                     const jmtx_allocator_callbacks *allocator_callbacks)
{
    ...
    jmtx_result res =
        jmtxz_matrix_cds_new(&mtx, in->base.rows, in->base.cols, 0, (const int32_t[]){0}, allocator_callbacks);
    if (res != JMTX_RESULT_SUCCESS)
    {
        return res;
    }
                                      ...
                                      const jmtx_allocator_callbacks *allocator_callbacks)
{
    ...
    return jmtxz_convert_crs_to_cds(in, p_out, allocator_callbacks);
}
                                      ...
                                      const jmtx_allocator_callbacks *allocator_callbacks)
{
    ...
    return jmtxz_convert_ccs_to_cds(in, p_out, allocator_callbacks);
}
                                      ...
                                      const jmtx_allocator_callbacks *allocator_callbacks)
{
    ...
    return jmtxz_convert_brm_to_crs(in, p_out, allocator_callbacks);
}
                                      ...
                                      const jmtx_allocator_callbacks *allocator_callbacks)
{
    ...
    return jmtxz_convert_brm_to_ccs(in, p_out, allocator_callbacks);
}
/**
                                     ...
                                     const jmtx_allocator_callbacks *allocator_callbacks)
{
    ...
    _Complex double *const value_array =
                                      ...
                                      const jmtx_allocator_callbacks *allocator_callbacks)
{
    ...
    return jmtxz_convert_brm_to_cds(in, p_out, allocator_callbacks);
}
/**
                                      ...
                                      const jmtx_allocator_callbacks *allocator_callbacks)
{
    ...
    return jmtxz_convert_crs_to_brm(in, p_out, allocator_callbacks);
}
                                      ...
                                      const jmtx_allocator_callbacks *allocator_callbacks)
{
    ...
    return jmtxz_convert_ccs_to_brm(in, p_out, allocator_callbacks);
}
                                     ...
                                     const jmtx_allocator_callbacks *allocator_callbacks)
{
    ...
    _Complex double *const values_in =
                                      ...
                                      const jmtx_allocator_callbacks *allocator_callbacks)
{
    ...
    return jmtxz_convert_cds_to_brm(in, p_out, allocator_callbacks);
}
