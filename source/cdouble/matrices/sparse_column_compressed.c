...
static uint32_t ccs_get_column_entries(const jmtxz_matrix_ccs *mtx, uint32_t col, uint32_t **pp_indices,
                                       _Complex double **pp_values)
{
    uint32_t offset, len;
    if (col == 0)
    {
 ...
 */
static jmtx_result ccs_insert_entry_at(jmtxz_matrix_ccs *mtx, uint32_t col, uint32_t position, _Complex double value,
                                       uint32_t index)
{
...
jmtx_result jmtxz_matrix_ccs_copy(const jmtxz_matrix_ccs *mtx, jmtxz_matrix_ccs **p_out,
                                  const jmtx_allocator_callbacks *allocator_callbacks)
{
    if (allocator_callbacks == NULL)
    {
...
jmtx_result jmtxzs_matrix_ccs_copy(const jmtxz_matrix_ccs *mtx, jmtxz_matrix_ccs **p_out,
                                   const jmtx_allocator_callbacks *allocator_callbacks)
{
    if (!mtx)
    {
