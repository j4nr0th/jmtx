 ...
 * @return JMTX_RESULT_SUCCESS if successful
 */
jmtx_result jmtxs_matrix_crs_vector_multiply(const jmtx_matrix_crs* mtx, const float* x, float* y);
 ...
 */
jmtx_result jmtxs_matrix_crs_join_vertically(jmtx_matrix_crs** output, const jmtx_allocator_callbacks* allocators, unsigned k, const jmtx_matrix_crs** matrix_list);
