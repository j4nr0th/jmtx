 ...
 */
void jmtxd_matrix_drm_givens_rotation_left(
    jmtxd_matrix_drm* mtx, unsigned r1, unsigned r2, const double ct, const double st)
{
 ...
 */
jmtx_result jmtxds_matrix_drm_givens_rotation_left(jmtxd_matrix_drm* mtx, const unsigned r1, const unsigned r2, double ct,
 double st)
{
