// Automatically generated from source/float/matrices/sparse_row_compressed.c on Thu Nov 30 20:33:08 2023
//
        ...
        const jmtx_allocator_callbacks* allocator_callbacks)
{
    ...
    return jmtxd_matrix_crs_new(p_mtx, cols, rows, reserved_entries, allocator_callbacks);
}
...
static inline bool is_bellow_magnitude(double x, double mag)
{
        ...
        const jmtxd_matrix_crs* mtx, jmtxd_matrix_crs** p_out, const jmtx_allocator_callbacks* allocator_callbacks)
{
    ...
    *column_cum_counts = 1;
    ...
    {
        n = jmtxd_matrix_crs_entries_in_col(mtx, j);
        (void) jmtxd_matrix_crs_get_col(mtx, j, n, new_values + p, new_indices + p);
                                            ...
                                            unsigned k, const jmtxd_matrix_crs* matrix_list[static k])
{
    ...
    jmtx_result res = jmtxd_matrix_crs_new(&out, col_count, n_rows, element_count, allocators);
...
jmtx_result jmtxds_matrix_crs_join_vertically(
        jmtxd_matrix_crs** output, const jmtx_allocator_callbacks* allocators, unsigned int k,
        const jmtxd_matrix_crs** matrix_list)
{
    ...
    return jmtxd_matrix_crs_join_vertically(output, allocators, k, matrix_list);
}
