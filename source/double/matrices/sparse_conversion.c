// Automatically generated from source/double/matrices/sparse_conversion.c on Fri Dec  1 06:43:01 2023
//
...
jmtx_result jmtxd_convertt_crs_to_cds(const jmtxd_matrix_crs* in, jmtxd_matrix_cds** p_out,
                                    const jmtx_allocator_callbacks* allocator_callbacks)
{
...
jmtx_result jmtxd_convertt_ccs_to_cds(const jmtxd_matrix_ccs* in, jmtxd_matrix_cds** p_out,
                                    const jmtx_allocator_callbacks* allocator_callbacks)
{
    jmtxd_matrix_cds* mtx;
    jmtx_result res = jmtxd_matrix_cds_new(
...
jmtx_result jmtxd_convertt_brm_to_crs(const jmtxd_matrix_brm* in, jmtxd_matrix_crs** p_out,
                                    const jmtx_allocator_callbacks* allocator_callbacks)
{
    const uint_fast32_t max_entries = (in->lower_bandwidth + in->upper_bandwidth + 1) * in->base.rows;
    jmtxd_matrix_crs* mtx;
    jmtx_result res = jmtxd_matrix_crs_new(&mtx, in->base.cols, in->base.rows, max_entries, allocator_callbacks);
    if (res != JMTX_RESULT_SUCCESS)
    {
        return res;
    }
...
jmtx_result jmtxd_convertt_brm_to_ccs(const jmtxd_matrix_brm* in, jmtxd_matrix_ccs** p_out,
                                    const jmtx_allocator_callbacks* allocator_callbacks)
{
    const uint_fast32_t max_entries = (in->lower_bandwidth + in->upper_bandwidth + 1) * in->base.rows;
    jmtxd_matrix_ccs* mtx;
    jmtx_result res = jmtxd_matrix_ccs_new(&mtx, in->base.cols, in->base.rows, max_entries, allocator_callbacks);
    if (res != JMTX_RESULT_SUCCESS)
    {
        return res;
    }
...
jmtx_result jmtxd_convertt_brm_to_cds(const jmtxd_matrix_brm* in, jmtxd_matrix_cds** p_out,
                                    const jmtx_allocator_callbacks* allocator_callbacks)
{
    ...
    jmtx_result res = jmtxd_matrix_cds_new(&mtx, in->base.cols, in->base.rows, 0, (const int32_t[]){0}, allocator_callbacks);
    if (res != JMTX_RESULT_SUCCESS)
    {
...
jmtx_result jmtxd_convertt_crs_to_brm(const jmtxd_matrix_crs* in, jmtxd_matrix_brm** p_out,
                                    const jmtx_allocator_callbacks* allocator_callbacks)
{
    if (!allocator_callbacks)
    {
    ...
    jmtx_result res = jmtxd_matrix_brm_new(&mtx, in->base.cols, in->base.rows, ubw, lbw, NULL, allocator_callbacks);
    if (res != JMTX_RESULT_SUCCESS)
    {
        return res;
    }
...
jmtx_result jmtxd_convertt_ccs_to_brm(const jmtxd_matrix_ccs* in, jmtxd_matrix_brm** p_out,
                                    const jmtx_allocator_callbacks* allocator_callbacks)
{
    if (!allocator_callbacks)
    {
...
jmtx_result jmtxd_convertt_cds_to_brm(const jmtxd_matrix_cds* in, jmtxd_matrix_brm** p_out,
                                    const jmtx_allocator_callbacks* allocator_callbacks)
{
    if (!allocator_callbacks)
    {
