 ...
 *                                                                                                                     *
 **********************************************************************************************************************/
#if defined(JMTXF_SPARSE_ROW_COMPRESSED_H) && defined(JMTX_SPARSE_ROW_COMPRESSED_H)
/**
 ...
 *                                                                                                                     *
 **********************************************************************************************************************/
#if defined(JMTX_SPARSE_ROW_COMPRESSED_H) && defined(JMTXZ_SPARSE_ROW_COMPRESSED_H) && !defined(JMTX_MSVC)
/**
