...
static const char *const jmtx_result_string_array[JMTX_RESULT_COUNT] = {
    ...
    [JMTX_RESULT_WRONG_TYPE] =
        "Wrong matrix type was passed", //  Matrix has the wrong storage type (e.g.: ccs instead of crs)
...
static const char *const jmtx_matrix_type_string_array[JMTX_TYPE_COUNT] = {
    ...
    [JMTXD_TYPE_DRM] = "Double precision dense row-major",            //  Dense row-major
    //  Complex Float
    ...
    [JMTXC_TYPE_DRM] = "Complex dense row-major",            //  Dense row-major
    //  Double
    ...
    [JMTXZ_TYPE_DRM] = "Complex Double precision dense row-major",            //  Dense row-major
};
...
JMTX_HOT_FUNCTION
uint32_t jmtx_internal_find_last_leq_value(uint32_t n_indices,
                                           const uint32_t p_indices[JMTX_ARRAY_ATTRIB(static n_indices)],
                                           uint32_t value)
{
    uint32_t p = 0;
