 ...
 */
JMTX_NODISCARD_FUNCTION
jmtx_result jmtxcs_matrix_crs_set_row(jmtxc_matrix_crs *mtx, uint32_t row, uint32_t n,
 ...
 */
JMTX_NODISCARD_FUNCTION
jmtx_result jmtxcs_matrix_crs_get_row(const jmtxc_matrix_crs *mtx, uint32_t row, uint32_t *n, uint32_t *p_indices[1],
...
jmtx_result jmtxcs_matrix_crs_get_col(const jmtxc_matrix_crs *mtx, uint32_t col, uint32_t n, uint32_t *p_count,
                                      _Complex float p_values[JMTX_ARRAY_ATTRIB(n)],
