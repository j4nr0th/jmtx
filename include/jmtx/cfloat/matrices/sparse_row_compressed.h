 ...
 */
jmtx_result jmtxc_matrix_crs_join_vertically(jmtxc_matrix_crs** output, const jmtx_allocator_callbacks* allocator_callbacks, unsigned k, const jmtxc_matrix_crs* matrix_list[JMTX_ARRAY_ATTRIB(static k)]);
