// Automatically generated from include/jmtx/float/matrices/sparse_column_compressed_safe.h on Fri Dec  1 17:35:57 2023
//
...
#ifndef JMTXC_SPARSE_COLUMN_COMPRESSED_SAFE_H
#define JMTXC_SPARSE_COLUMN_COMPRESSED_SAFE_H
...
/**
 * Similar to jmtxc_matrix_zero_all_entries, but slower, since it can not use memset. On the other hand, it allows for
 ...
 * @return JMTX_RESULT_SUCCESS if successful
 */
jmtx_result jmtxcs_matrix_ccs_copy(const jmtxc_matrix_ccs *restrict mtx, jmtxc_matrix_ccs **p_out,
                                   const jmtx_allocator_callbacks *allocator_callbacks);
#endif // JMTXC_SPARSE_COLUMN_COMPRESSED_SAFE_H
