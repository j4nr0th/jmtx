// Automatically generated from include/jmtx/float/matrices/sparse_column_compressed.h on Fri Dec  1 17:35:57 2023
//
...
#define JMTXC_SPARSE_COLUMN_COMPRESSED_H
#ifndef JMTX_MATRIX_BASE_H
#    include "../../matrix_base.h"
#endif

typedef struct jmtxc_matrix_ccs_struct jmtxc_matrix_ccs;
...
/**
 * Version of jmtxc_matrix_ccs_set_col which does not touch the count of entries after the current column. This is
...
/**
 * Removes entries exactly equal to zero. If the element is indeed zero, it is compared to (_Complex float)0.0
 * @param mtx pointer to the memory where the matrix is stored
 */
 ...
 * @return JMTX_RESULT_SUCCESS if successful, JMTX_RESULT_BAD_ALLOC on memory allocation failure
 */
jmtx_result jmtxc_matrix_ccs_copy(const jmtxc_matrix_ccs *restrict mtx, jmtxc_matrix_ccs **p_out,
                                  const jmtx_allocator_callbacks *allocator_callbacks);
...
#endif // JMTXC_SPARSE_COLUMN_COMPRESSED_H
