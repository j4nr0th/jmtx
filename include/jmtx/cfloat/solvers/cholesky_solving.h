 ...
 */
void jmtxc_solve_direct_cholesky_crs(const jmtxc_matrix_crs *c, const jmtxc_matrix_crs *ct,
                                     const _Complex float *restrict y, _Complex float *restrict x);
 ...
 */
void jmtxc_solve_direct_cholesky_crs_inplace(const jmtxc_matrix_crs *c, const jmtxc_matrix_crs *ct,
