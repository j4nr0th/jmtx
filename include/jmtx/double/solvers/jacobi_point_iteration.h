 ...
 * in case of failure it returns the associated error code
 */
jmtx_result jmtxd_jacobi_relaxed_cds(
 ...
 * in case of failure it returns the associated error code
 */
jmtx_result jmtxd_jacobi_relaxed_brm(
 ...
 * in case of failure it returns the associated error code
 */
jmtx_result jmtxd_jacobi_brm_parallel(
