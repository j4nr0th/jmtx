 ...
 * @return JMTX_RESULT_SUCCESS if successful
 */
jmtx_result jmtxds_matrix_ccs_vector_multiply(const jmtxd_matrix_ccs *mtx, const double *restrict x,
                                              double *restrict y);
 ...
 * @return JMTX_RESULT_SUCCESS if successful
 */
jmtx_result jmtxds_matrix_ccs_copy(const jmtxd_matrix_ccs *restrict mtx, jmtxd_matrix_ccs **p_out,
                                   const jmtx_allocator_callbacks *allocator_callbacks);
