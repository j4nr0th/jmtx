 ...
 */
JMTX_NODISCARD_FUNCTION
jmtx_result jmtxds_matrix_crs_join_vertically(jmtxd_matrix_crs** output, const jmtx_allocator_callbacks* allocator_callbacks, unsigned k, const jmtxd_matrix_crs* matrix_list[JMTX_ARRAY_ATTRIB(static k)]);
