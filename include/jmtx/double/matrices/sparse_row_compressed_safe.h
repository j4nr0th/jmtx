 ...
 */
JMTX_NODISCARD_FUNCTION
jmtx_result jmtxds_matrix_crs_set_row(jmtxd_matrix_crs *mtx, uint32_t row, uint32_t n,
 ...
 */
JMTX_NODISCARD_FUNCTION
jmtx_result jmtxds_matrix_crs_get_row(const jmtxd_matrix_crs *mtx, uint32_t row, uint32_t *n, uint32_t *p_indices[1],
                                      double *p_elements[1]);
 ...
 */
JMTX_NODISCARD_FUNCTION
jmtx_result jmtxds_matrix_crs_vector_multiply(const jmtxd_matrix_crs *mtx, const double *restrict x,
                                              double *restrict y);
