...
/**
 * Version of jmtxd_matrix_crs_set_row which does not touch the count of entries after the current row. This is useful
...
/**
 * Similar to jmtxd_matrix_crs_zero_all_entries, but slower, since it can not use memset. On the other hand, it allows
