 ...
 */
jmtx_result jmtxds_matrix_multiply_crs(const jmtx_matrix_crs* a, const jmtx_matrix_ccs* b, jmtx_matrix_crs** p_out,
 ...
 * @return JMTX_RESULT_SUCCESS if successful
 */
jmtx_result jmtxds_matrix_multiply_ccs(const jmtx_matrix_crs* a, const jmtx_matrix_ccs* b, jmtx_matrix_ccs** p_out,
                                     const jmtx_allocator_callbacks* allocator_callbacks);
#endif
 ...
 * @return JMTX_RESULT_SUCCESS if successful
 */
jmtx_result jmtxds_matrix_multiply_brm(const jmtx_matrix_brm* a, const jmtx_matrix_brm* b, jmtx_matrix_brm** p_out,
                                     const jmtx_allocator_callbacks* allocator_callbacks);
#endif
 ...
 * @return JMTX_RESULT_SUCCESS if successful
 */
jmtx_result jmtxds_matrix_multiply_cds(const jmtx_matrix_cds* a, const jmtx_matrix_cds* b, jmtx_matrix_cds** p_out,
                                     const jmtx_allocator_callbacks* allocator_callbacks);
#endif
