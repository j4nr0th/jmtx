 ...
 * @return JMTX_RESULT_SUCCESS if successful
 */
jmtx_result jmtxds_matrix_brm_vector_multiply(const jmtxd_matrix_brm *mtx, const double *restrict x,
                                              double *restrict y);
...
/**
 * Similar to jmtxd_matrix_brm_zero_all_entries, but slower, since it can not use memset. On the other hand, it allows
