...
#define JMTXF_SPARSE_ROW_COMPRESSED_H
#ifndef JMTX_MATRIX_BASE_H
#    include "../../matrix_base.h"
#endif

typedef struct jmtxf_matrix_crs_struct jmtxf_matrix_crs;
...
/**
 * Version of jmtxf_matrix_crs_set_row which does not touch the count of entries after the current row. This is useful
 ...
 * input matrices, return value of jmtxf_matrix_crs_new if that fails
 */
