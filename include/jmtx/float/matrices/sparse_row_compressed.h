...
/**
 * Version of jmtx_matrix_crs_set_row which does not touch the count of entries after the current row. This is useful
 ...
 * p_elements
 */
uint32_t jmtx_matrix_crs_get_row(const jmtx_matrix_crs *mtx, uint32_t row, uint32_t *p_indices[1],
                                 float *p_elements[1]);
