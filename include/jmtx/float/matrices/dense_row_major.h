...
#define JMTXF_DENSE_ROW_MAJOR_H
 ...
 * exact way.
 */
typedef struct jmtxf_matrix_drm_struct jmtxf_matrix_drm;
 ...
 */
void jmtxf_matrix_drm_givens_rotation_left(jmtxf_matrix_drm *mtx, unsigned r1, unsigned r2, float ct, float st);
 ...
 */
jmtx_result jmtxs_matrix_drm_givens_rotation_left(jmtxf_matrix_drm *mtx, unsigned r1, unsigned r2, float ct, float st);
