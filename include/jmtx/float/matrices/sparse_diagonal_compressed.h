 ...
 * @return JMTX_RESULT_SUCCESS if successful, JMTX_RESULT_BAD_ALLOC on memory allocation failure
 */
jmtx_result jmtx_matrix_cds_set_diagonal_full(jmtx_matrix_cds* mtx, int32_t dia_idx, const float values[]);
 ...
 */
uint32_t
jmtx_matrix_cds_get_col(const jmtx_matrix_cds* mtx, uint32_t col, uint32_t n, float p_values[JMTX_ARRAY_ATTRIB(restrict n)],
 ...
 * @return JMTX_RESULT_SUCCESS if successful, JMTX_RESULT_BAD_ALLOC on memory allocation failure
 */
jmtx_result jmtx_matrix_cds_copy(const jmtx_matrix_cds* mtx, jmtx_matrix_cds** p_out, const jmtx_allocator_callbacks* allocator_callbacks);
