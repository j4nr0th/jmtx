...
#ifndef JMTXF_INCOMPLETE_CHOLESKY_DECOMPOSITION_H
#define JMTXF_INCOMPLETE_CHOLESKY_DECOMPOSITION_H
 ...
 * sparsity pattern as the matrix A. C' is a lower triangular matrix.
 *
 ...
 * JMTX_RESULT_NOT_CONVERGED if convergence was not achieved in the number of specified iterations,
...
#endif // JMTXF_INCOMPLETE_CHOLESKY_DECOMPOSITION_H
