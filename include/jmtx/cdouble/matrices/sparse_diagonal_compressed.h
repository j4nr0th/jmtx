// Automatically generated from include/jmtx/cfloat/matrices/sparse_diagonal_compressed.h on Fri Dec  1 18:48:13 2023
// Automatically generated from include/jmtx/cdouble/matrices/sparse_diagonal_compressed.h on Fri Dec  1 17:35:57 2023
//
// Created by jan on 27.11.2023.
//

#ifndef JMTXZ_SPARSE_DIAGONAL_COMPRESSED_H
#define JMTXZ_SPARSE_DIAGONAL_COMPRESSED_H
 ...
 * @return JMTX_RESULT_SUCCESS if successful, JMTX_RESULT_BAD_ALLOC on memory allocation failure
 */
jmtx_result jmtxz_matrix_cds_set_diagonal_full(jmtxz_matrix_cds* mtx, int32_t dia_idx, const _Complex double values[]);
 ...
 */
uint32_t
jmtxz_matrix_cds_get_col(const jmtxz_matrix_cds* mtx, uint32_t col, uint32_t n, _Complex double p_values[JMTX_ARRAY_ATTRIB(restrict n)],
 ...
 * @return JMTX_RESULT_SUCCESS if successful, JMTX_RESULT_BAD_ALLOC on memory allocation failure
 */
jmtx_result jmtxz_matrix_cds_copy(const jmtxz_matrix_cds* mtx, jmtxz_matrix_cds** p_out, const jmtx_allocator_callbacks* allocator_callbacks);
