...
// Automatically generated from include/jmtx/cdouble/matrices/sparse_column_compressed_safe.h on Fri Dec  1 17:35:57 2023
//
...
/**
 * Similar to jmtxz_matrix_ccs_zero_all_elements, but slower, since it can not use memset. On the other hand, it allows for
 ...
 * @return JMTX_RESULT_SUCCESS if successful
 */
jmtx_result jmtxzs_matrix_ccs_copy(const jmtxz_matrix_ccs* restrict mtx, jmtxz_matrix_ccs** p_out, const jmtx_allocator_callbacks* allocator_callbacks);
