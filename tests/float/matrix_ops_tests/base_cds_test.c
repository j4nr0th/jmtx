...
static int are_value_arrays_the_same(unsigned len, const float a1[JMTX_ARRAY_ATTRIB(const static len)], const float a2[JMTX_ARRAY_ATTRIB(const static len)])
{
...
int test_row(void)
{
    ...
    ASSERT(are_value_arrays_the_same(cnt, column_vals, (float[]) {1.0f, -1.0f}));
    ...
    ASSERT(are_value_arrays_the_same(cnt, column_vals, (float[]) {2.0f, -2.0f, 1.0f}));
    ...
    ASSERT(are_value_arrays_the_same(cnt, column_vals, (float[]) {3.0f, -3.0f, 2.0f, -5.0f}));
    ...
    ASSERT(are_value_arrays_the_same(cnt, column_vals, (float[]) {-4.0f, 3.0f, -6.0f, 69.0f}));
    ...
    ASSERT(are_value_arrays_the_same(cnt, column_vals, (float[]) {4.0f, -7.0f, 420.0f}));
