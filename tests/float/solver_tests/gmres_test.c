...
int main()
{
    ...
    float* const forcing_vector = calloc(sizeof(*forcing_vector), PROBLEM_DIMS); // forcing vector for u (all values are 1)
...
//    print_crsd_matrix(mtx);
...

    {
        ...
        mtx_res = jmtx_solve_iterative_gmresm_crs(
