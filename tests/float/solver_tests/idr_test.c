...
int main()
{
    ...
    jmtxf_matrix_drm *p_mat, *aux_mat1, *aux_mat2, *aux_mat3, *aux_mat4, *aux_mat5;
    MATRIX_TEST_CALL(jmtxf_matrix_drm_new(&p_mat, PROBLEM_INTERNAL_PTS, WORK_DIVISIONS, NULL, NULL));
    ASSERT(mtx_res == JMTX_RESULT_SUCCESS);
    MATRIX_TEST_CALL(jmtxf_matrix_drm_new(&aux_mat1, PROBLEM_INTERNAL_PTS, WORK_DIVISIONS, NULL, NULL));
    ASSERT(mtx_res == JMTX_RESULT_SUCCESS);
    MATRIX_TEST_CALL(jmtxf_matrix_drm_new(&aux_mat2, PROBLEM_INTERNAL_PTS, WORK_DIVISIONS, NULL, NULL));
    ASSERT(mtx_res == JMTX_RESULT_SUCCESS);
    MATRIX_TEST_CALL(jmtxf_matrix_drm_new(&aux_mat3, WORK_DIVISIONS, WORK_DIVISIONS, NULL, NULL));
    ASSERT(mtx_res == JMTX_RESULT_SUCCESS);
    MATRIX_TEST_CALL(jmtxf_matrix_drm_new(&aux_mat4, WORK_DIVISIONS, WORK_DIVISIONS, NULL, NULL));
    ASSERT(mtx_res == JMTX_RESULT_SUCCESS);
    MATRIX_TEST_CALL(jmtxf_matrix_drm_new(&aux_mat5, WORK_DIVISIONS, WORK_DIVISIONS, NULL, NULL));
    ASSERT(mtx_res == JMTX_RESULT_SUCCESS);
    ...
    {
        float *elems;
        const uint_fast32_t len = jmtxf_matrix_drm_get_row(p_mat, i, &elems);
        ...
        for (uint32_t j = 0; j < i; ++j)
        {
            float v = 0;
            float *other;
            (void)jmtxf_matrix_drm_get_row(p_mat, j, &other);
    ...
    jmtxf_matrix_drm_destroy(aux_mat5);
    jmtxf_matrix_drm_destroy(aux_mat4);
    jmtxf_matrix_drm_destroy(aux_mat3);
    jmtxf_matrix_drm_destroy(aux_mat2);
    jmtxf_matrix_drm_destroy(aux_mat1);
    jmtxf_matrix_drm_destroy(p_mat);
