...
int main()
{
    ...
    ASSERT(aux_v5);
    double *const aux_v6 = calloc(RESTART_INTERVAL, sizeof(*aux_v6));
    ASSERT(aux_v6);
...

    {
        ...
        mtx_res = jmtxd_solve_iterative_gmresm_lpc_jacobi_cds(mtx, forcing_vector + 1, iterative_solution + 1,
