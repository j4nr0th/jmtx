// Automatically generated from tests/float/matrix_ops_tests/io_test.c on Fri Dec  1 17:35:45 2023
//
// Created by jan on 23.11.2023.
//
#include "../../../include/jmtx/cfloat/matrices/sparse_row_compressed.h"
#include "../../../source/cfloat/matrices/basic_io.h"
...
int main()
{
    ...
    MATRIX_TEST_CALL(jmtxc_matrix_crs_to_file(mtx, "test_output_matrix.txt"));
    ASSERT(mtx_res == JMTX_RESULT_SUCCESS);
    MATRIX_TEST_CALL(jmtxc_matrix_crs_to_file_explicit(mtx, "test_output_matrix_full.txt"));
    ASSERT(mtx_res == JMTX_RESULT_SUCCESS);
