...
int main()
{
    ...
    _Complex float *const forcing_vector =
    ...
    MATRIX_TEST_CALL(
        jmtxc_matrix_brm_new(&r_mtx, RESTART_INTERVAL, RESTART_INTERVAL, RESTART_INTERVAL - 1, 0, NULL, NULL));
...

    {
        ...
        mtx_res = jmtxc_solve_iterative_gmresr_cds(mtx, forcing_vector + 1, iterative_solution + 1, RESTART_INTERVAL,
