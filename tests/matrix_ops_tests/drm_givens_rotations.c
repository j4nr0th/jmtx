...
static void eliminate_entry_upper(JMTX_NAME_TYPED(matrix_drm) * mat, unsigned i, unsigned j)
{
    ASSERT(i < N - 1);
    ASSERT(j < N && j > 0);
...
static void eliminate_entry_upper3(JMTX_NAME_TYPED(matrix_drm) * mat, unsigned i, unsigned j,
                                   JMTX_NAME_TYPED(matrix_drm) * q, const double k)
{
    ASSERT(i < N - 1);
    ASSERT(j < N && j > 0);
...
int main()
{
    ...
    const double test_mtx[10][10] = {
        ...
        {8.87853218e+00, 1.02529999e+01, 2.37271179e+00, 5.17398860e+00, 1.00826664e+01, 1.11075517e+01, 7.13036746e+00,
         1.17493454e+01, 1.77385227e+01, 1.04822984e+01},
        {1.78103937e+01, 1.03459385e+01, 1.36421969e+01, 1.12666930e+01, 1.34104608e+01, 1.90105495e+01, 1.62282831e+01,
         1.66403782e+01, 2.52998740e+01, 1.54449266e+01},
        {-2.34713027e+00, -1.75548765e-01, -1.84975549e+00, 4.89821115e+00, -1.94769257e+00, -2.70141981e+00,
         -1.31135359e+00, -1.09114439e+00, -1.62483941e+00, -3.44355829e+00},
        {-1.28426281e+01, -7.11970557e+00, -6.80271675e+00, -9.94719089e+00, -5.86475873e+00, -1.53803551e+01,
         -1.19640075e+01, -1.21198316e+01, -2.04377617e+01, -1.10298175e+01},
        {-2.72166450e+00, -2.71507999e+00, 6.90919570e-02, -1.61678507e+00, -4.34207038e+00, 3.10907001e+00,
         -2.72571998e+00, -6.61231055e+00, -9.13022538e+00, -1.14666503e+00},
        {-4.85345791e+00, -1.47750783e+00, -4.87786804e-01, 1.33286497e-02, -5.81594367e+00, -6.36392117e+00,
         4.00901832e+00, -8.32049466e+00, -1.18981128e+01, -5.34052768e+00},
        {
            1.08147050e+00,
            2.96506565e+00,
            2.37352500e+00,
        ...
        {1.05196554e+01, 6.57305058e+00, 4.59358487e+00, 7.79203169e+00, 9.38301381e+00, 1.14361057e+01, 8.98885188e+00,
         1.20202018e+01, 2.38855341e+01, 8.09582798e+00},
        {8.44920356e+00, 5.62215091e+00, 3.81473180e+00, 5.18012195e+00, 7.22907146e+00, 8.41499314e+00, 7.65680220e+00,
         9.62350611e+00, 1.43238900e+01, 1.05355246e+01}};
