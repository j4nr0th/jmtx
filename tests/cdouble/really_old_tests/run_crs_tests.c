// Automatically generated from tests/cfloat/really_old_tests/run_crs_tests.c on Fri Dec  1 18:48:10 2023
// Automatically generated from tests/cdouble/really_old_tests/run_crs_tests.c on Fri Dec  1 17:35:45 2023
//
...
int main()
{
    ...
    jmtxz_matrix_crs_new(&matrix, 25, 25, 2, NULL);


    const uint32_t indices[3] = {1, 2, 4};
    const _Complex double values[3] = { 69, 420, 505};
    jmtxz_matrix_crs_set_row(matrix, 2, 3, indices, values);
    ...
    uint32_t funny = 0;
    jmtxz_matrix_crs_set_entry(matrix, 1, 9, -100);
    jmtxz_matrix_crs_set_entry(matrix, 6, 9, -200);
    jmtxz_matrix_crs_set_entry(matrix, 2, 24, -300);
    jmtxz_matrix_crs_apply_unary_fn(matrix, make_the_values_funnier, &funny);
    jmtxz_matrix_crs_set_entry(matrix, 2, 9, -400);
    jmtxz_matrix_crs_shrink(matrix);
    ...
    printf("Row 2 is:\n");
    {
        ...
        uint32_t* ind;
        _Complex double* val;
        n = jmtxz_matrix_crs_get_row(matrix, 2, &ind, &val);
    ...
    jmtxz_matrix_crs_new(&matrix_1, 5, 5, 0, NULL);

    {
        const uint32_t i[] = { 0 };
        const _Complex double v[] = { 1.0f };
        jmtxz_matrix_crs_set_row(matrix_1, 0, 1, i, v);
    }

    {
        const uint32_t i[] = { 0, 1 };
        const _Complex double v[] = { 0.75f, 0.25f };
        jmtxz_matrix_crs_set_row(matrix_1, 1, 2, i, v);
    }

    {
        const uint32_t i[] = { 1, 2, 3 };
        const _Complex double v[] = { 1, 2, 1};
        jmtxz_matrix_crs_set_row(matrix_1, 2, 3, i, v);
    }

    {
        const uint32_t i[] = { 3, 4 };
        const _Complex double v[] = { 0.75f, 0.25f };
        jmtxz_matrix_crs_set_row(matrix_1, 3, 2, i, v);
    }

    {
        const uint32_t i[] = { 4 };
        const _Complex double v[] = {1};
        jmtxz_matrix_crs_set_row(matrix_1, 4, 1, i, v);
    }
    ...
    jmtxz_matrix_crs* tmp;
    jmtxz_matrix_crs_transpose(matrix, &tmp, NULL);
    for (uint32_t i = 0; i < 25; ++i)
    {
        for (uint32_t j = 0; j < 25; ++j)
        {
            _Complex double x1,x2;
            x1 = jmtxz_matrix_crs_get_entry(matrix, i, j);
            x2 = jmtxz_matrix_crs_get_entry(tmp, j, i);
            if (x1 != x2)
            {
                err_count += 1;
            }
    ...
    jmtxz_matrix_crs_destroy(tmp);

    jmtxz_matrix_crs_copy(matrix, &tmp, NULL);
    err_count = 0;
    for (uint32_t i = 0; i < 25; ++i)
    {
        for (uint32_t j = 0; j < 25; ++j)
        {
            _Complex double x1,x2;
            x1 = jmtxz_matrix_crs_get_entry(matrix, i, j);
            x2 = jmtxz_matrix_crs_get_entry(tmp, i, j);
            if (x1 != x2)
            {
                err_count += 1;
            }
    ...
    jmtxz_matrix_crs_destroy(matrix_1);
    jmtxz_matrix_crs_destroy(matrix_2);
    ...
    jmtxz_matrix_crs_vector_multiply(matrix, v1, y);
    printf("x:");
    for (uint32_t i = 0; i < 25; ++i)
    {
    ...
    printf("\nHello world!\n");
//    printf("Matrix is currently using %zu bytes of memory\n", jmtxz_matrix_crs_memory_usage(matrix));
    jmtxz_matrix_crs_destroy(matrix);
