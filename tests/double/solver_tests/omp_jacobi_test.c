// Automatically generated from tests/float/solver_tests/omp_jacobi_test.c on Fri Dec  1 06:43:09 2023
//
...
int main()
{
    ...
    double aux_v1[PROBLEM_DIMS], aux_v2[PROBLEM_DIMS];
...
//    print_crsd_matrix(mtx);
    ...
    mtx_res = jmtxd_solve_iterative_jacobi_crs_parallel(mtx, forcing_vector, iterative_solution + 1, aux_v1, aux_v2, &solver_arguments);
