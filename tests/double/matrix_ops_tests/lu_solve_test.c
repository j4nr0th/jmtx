// Automatically generated from tests/float/matrix_ops_tests/lu_solve_test.c on Thu Nov 30 20:00:39 2023
//
...
constexpr double default_r_tol = FLT_EPSILON * 400;
constexpr double default_a_tol = FLT_EPSILON * 100;
